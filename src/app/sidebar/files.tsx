...
function CustomTreeItem({ itemId, ...props }: { itemId: string }) {
    ...
    return <TreeItem2 className='[&_.MuiTreeItem-label]:whitespace-nowrap [&_.MuiTreeItem-label]:!font-sans' slots={{ icon: iconMap[extension] }} itemId={itemId} {...props}></TreeItem2>
}
...
export default function Files({ workspaceId }: { workspaceId: string }) {
    ...
    <RichTreeView items={treeItems} slots={{
        item: CustomTreeItem,
